-- @version 1.0
-- @description Rescale Take Start Offset Using an FPS Ratio
-- @author RESERVOIR AUDIO / Fante, with AI.


-- Rescale take source start offset using an FPS ratio
-- Applies: new_offset = old_offset * (timeline_fps / source_fps)
-- Example: 25fps source -> 23.976 timeline:
	-- Start offset: 19:24.246 (1164.246s) becomes: 18:36.558 (1116.558s)
